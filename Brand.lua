...
if not DevAli:get(ServerBRAND.."IdBRAND") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevAli:set(ServerBRAND.."IdBRAND",DevId) 
else 
print('\27[1;31m┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉') 
end 
os.execute('lua BRAND.lua') 
end 
if not DevAli:get(ServerBRAND.."TokenBRAND") then 
...
DevAli:set(ServerBRAND.."TokenBRAND",TokenBot) 
end  
else 
...
Config = {
DevId = DevAli:get(ServerBRAND.."IdBRAND"),
TokenBot = DevAli:get(ServerBRAND.."TokenBRAND"),
BRAND = DevAli:get(ServerBRAND.."TokenBRAND"):match("(%d+)"),
SudoIds = {DevAli:get(ServerBRAND.."IdBRAND")},
}
...
#!/usr/bin/env bash
cd $HOME/BRAND
token="]]..DevAli:get(ServerBRAND.."TokenBRAND")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉"
...
f:close() 
DevAli:del(ServerBRAND.."IdBRAND");DevAli:del(ServerBRAND.."TokenBRAND")
end 
...
BRAND = Config.BRAND or Config.bot_id
TokenBot = Config.TokenBot or Config.token
NameBot = (DevAli:get(BRAND..'Ali:NameBot') or 'لورين')
--     Source BRAND     --
...
local Status = DevAli:sismember(BRAND..'Ali:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(BRAND) then  
var = true  
end  
return var  
end 
...
local Status = DevAli:sismember(BRAND..'Ali:SudoBot:',msg.sender_user_id_) 
...
local Status = DevAli:sismember(BRAND..'Ali:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevAli:sismember(BRAND..'Ali:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAli:sismember(BRAND..'Ali:VipAll:',msg.sender_user_id_) 
...
local Status = DevAli:sismember(BRAND..'Ali:AliConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevAli:sismember(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAli:sismember(BRAND..'Ali:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAli:sismember(BRAND..'Ali:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevAli:sismember(BRAND..'Ali:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevAli:sismember(BRAND..'Ali:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevAli:sismember(BRAND..'Ali:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevAli:sismember(BRAND..'Ali:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAli:sismember(BRAND..'Ali:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevAli:sismember(BRAND..'Ali:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevAli:sismember(BRAND..'Ali:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
DevAli:set(BRAND.."Ali:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevAli:sadd(BRAND.."Ali:Groups",IdGps) 
DevAli:set(BRAND.."Ali:Lock:Bots"..IdGps,"del") DevAli:hset(BRAND.."Ali:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevAli:set(BRAND..Lock..IdGps,true)
end
if v.AliConstructors then
for k,IdAliConstructors in pairs(v.AliConstructors) do
DevAli:sadd(BRAND..'Ali:AliConstructor:'..IdGps,IdAliConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevAli:sadd(BRAND..'Ali:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevAli:sadd(BRAND..'Ali:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevAli:sadd(BRAND..'Ali:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevAli:sadd(BRAND..'Ali:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevAli:sadd(BRAND..'Ali:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevAli:set(BRAND.."Ali:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevAli:set(BRAND.."Ali:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source BRAND     --
local AliRank = function(msg) if SudoId(msg.sender_user_id_) then BRANDTEAM  = "المطور" elseif SecondSudo(msg) then BRANDTEAM = "المطور" elseif SudoBot(msg) then BRANDTEAM = "المطور" elseif ManagerAll(msg) then BRANDTEAM = "المدير" elseif AdminAll(msg) then BRANDTEAM = "الادمن" elseif AliConstructor(msg) then BRANDTEAM = "المالك" elseif BasicConstructor(msg) then BRANDTEAM = "المنشئ" elseif Constructor(msg) then BRANDTEAM = "المنشئ" elseif Manager(msg) then BRANDTEAM = "المدير" elseif Admin(msg) then BRANDTEAM = "الادمن" else BRANDTEAM = "العضو" end return BRANDTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1783964439) then BRANDTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(BRAND) then BRANDTEAM = 'البوت' elseif SudoId(user_id) then BRANDTEAM = 'المطور الاساسي' elseif DevAli:sismember(BRAND..'Ali:SecondSudo:', user_id) then BRANDTEAM = 'المطور الثانوي' elseif DevAli:sismember(BRAND..'Ali:SudoBot:', user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAli:sismember(BRAND..'Ali:ManagerAll:', user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAli:sismember(BRAND..'Ali:AdminAll:', user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAli:sismember(BRAND..'Ali:VipAll:', user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAli:sismember(BRAND..'Ali:AliConstructor:'..chat_id, user_id) then BRANDTEAM = 'المالك' elseif DevAli:sismember(BRAND..'Ali:BasicConstructor:'..chat_id, user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAli:sismember(BRAND..'Ali:Constructor:'..chat_id, user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAli:sismember(BRAND..'Ali:Managers:'..chat_id, user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:Managers:Rd"..chat_id) or 'المدير' elseif DevAli:sismember(BRAND..'Ali:Admins:'..chat_id, user_id) then BRANDTEAM = DevAli:get(BRAND.."Ali:Admins:Rd"..chat_id) or 'الادمن' elseif DevAli:sismember(BRAND..'Ali:VipMem:'..chat_id, user_id) then  BRANDTEAM = DevAli:get(BRAND.."Ali:VipMem:Rd"..chat_id) or 'المميز' elseif DevAli:sismember(BRAND..'Ali:Cleaner:'..chat_id, user_id) then  BRANDTEAM = DevAli:get(BRAND.."Ali:Cleaner:Rd"..chat_id) or 'المنظف' else BRANDTEAM = DevAli:get(BRAND.."Ali:mem:Rd"..chat_id) or 'العضو' end return BRANDTEAM end
--     Source BRAND     --
...
var = true  
elseif DevAli:sismember(BRAND..'Ali:SecondSudo:', user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:SudoBot:', user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:ManagerAll:', user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:AdminAll:', user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:VipAll:', user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:AliConstructor:'..chat_id, user_id) then
var = true
elseif DevAli:sismember(BRAND..'Ali:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevAli:sismember(BRAND..'Ali:Constructor:'..chat_id, user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:Managers:'..chat_id, user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:Admins:'..chat_id, user_id) then
var = true  
elseif DevAli:sismember(BRAND..'Ali:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local ali = (BRAND..'Ali:Filters:'..msg.chat_id_)
if ali then
...
--     Source BRAND     --
function alimoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevAli:get(BRAND..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source BRAND     --
function ChCheck(msg)
local var = true 
if DevAli:get(BRAND.."Ali:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevAli:get(BRAND..'Ali:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevAli:get(BRAND..'Ali:ChText') then
local ChText = DevAli:get(BRAND..'Ali:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAli:get(BRAND.."Ali:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevAli:get(BRAND..'yes'..data.sender_user_id_) == 'delyes' then
DevAli:del(BRAND..'yes'..data.sender_user_id_, 'delyes')
DevAli:del(BRAND..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevAli:get(BRAND..'no'..data.sender_user_id_) == 'delno' then
DevAli:del(BRAND..'yes'..data.sender_user_id_, 'delyes')
DevAli:del(BRAND..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم الغاء امر اطردني") 
end
--     Source BRAND     --
if DataText == '/yesdel' and DevAli:get(BRAND..'yesdel'..data.sender_user_id_) == 'delyes' then
DevAli:del(BRAND..'yesdel'..data.sender_user_id_, 'delyes')
DevAli:del(BRAND..'nodel'..data.sender_user_id_, 'delno')
if DevAli:sismember(BRAND..'Ali:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAli:sismember(BRAND..'Ali:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevAli:sismember(BRAND..'Ali:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAli:sismember(BRAND..'Ali:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAli:sismember(BRAND..'Ali:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevAli:sismember(BRAND..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevAli:sismember(BRAND..'Ali:Constructor:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(BRAND..'Ali:Managers:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(BRAND..'Ali:Admins:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(BRAND..'Ali:VipMem:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(BRAND..'Ali:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevAli:sismember(BRAND..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevAli:srem(BRAND..'Ali:Constructor:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(BRAND..'Ali:Managers:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(BRAND..'Ali:Admins:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(BRAND..'Ali:VipMem:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(BRAND..'Ali:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevAli:srem(BRAND..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevAli:get(BRAND.."Ali:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم الغاء امر تغير المطور الاساسي") 
DevAli:del(BRAND.."Ali:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevAli:get(BRAND.."Ali:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevAli:get(BRAND..'nodel'..data.sender_user_id_) == 'delno' then
DevAli:del(BRAND..'yesdel'..data.sender_user_id_, 'delyes')
DevAli:del(BRAND..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevAli:get(BRAND.."Ali:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevAli:smembers(BRAND..'Ali:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevAli:incrby(BRAND..'Ali:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevAli:del(BRAND..'Ali:ListRolet'..data.chat_id_) 
DevAli:del(BRAND.."Ali:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "♪︙*صاحب الحظ* ↫ ["..UserName.."]\n♪︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevAli:del(BRAND..'Ali:ListRolet'..data.chat_id_) 
DevAli:del(BRAND.."Ali:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevAli:del(BRAND.."Ali:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevAli:sismember(BRAND..'Ali:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevAli:srem(BRAND..'Ali:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevAli:del(BRAND..'Ali:Text:GpTexts'..Abbs..data.chat_id_)
DevAli:srem(BRAND..'Ali:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevAli:smembers(BRAND..'Ali:Text:GpTexts'..Abbs..data.chat_id_)
if DevAli:get(BRAND..'Ali:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "♪︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Abbs) 
DevAli:del(BRAND..'Ali:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevAli:del(BRAND..'Ali:Text:GpTexts'..Abbs..data.chat_id_)
DevAli:del(BRAND..'Ali:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevAli:srem(BRAND..'Ali:Manager:GpRedod'..data.chat_id_,Abbs)
else
EditMsg(Chat_Id2, Msg_Id2, "♪︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevAli:get(BRAND..'Ali:Help')
local Text = [[
...
local Help = DevAli:get(BRAND..'Ali:Help1')
local Text = [[
...
local Help = DevAli:get(BRAND..'Ali:Help2')
local Text = [[
♪︙اوامر الادمنيه ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
♪︙الاعدادت
...
local Help = DevAli:get(BRAND..'Ali:Help3')
local Text = [[
♪︙اوامر المدراء ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
♪︙فحص البوت
...
local Help = DevAli:get(BRAND..'Ali:Help4')
local Text = [[
♪︙اوامر المنشئين ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
♪︙تنزيل الكل
...
local Help = DevAli:get(BRAND..'Ali:Help5')
local Text = [[
♪︙اوامر المطورين ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
♪︙الكروبات
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevAli:get(BRAND..'Ali:Help6')
local Text = [[
♪︙اوامر الاعضاء ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
...
if text and DevAli:get(BRAND.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevAli:get(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevAli:del(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevAli:del(BRAND.."Set:Cmd:Group:New"..msg.chat_id_)
DevAli:srem(BRAND.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevAli:del(BRAND.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevAli:get(BRAND..'Ali:NameBot') or "لورين")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAli:get(BRAND..'Ali:NameBot') or "لورين")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevAli:get(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevAli:get(BRAND.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevAli:set(BRAND.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙ارسل الامر الجديد", 1, 'html')
DevAli:del(BRAND.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevAli:set(BRAND.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevAli:get(BRAND.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevAli:get(BRAND.."Set:Cmd:Group:New"..msg.chat_id_)
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الامر", 1, 'html')
DevAli:del(BRAND.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevAli:smembers(BRAND.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "♪︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
Cmds = DevAli:get(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevAli:smembers(BRAND.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevAli:del(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevAli:del(BRAND.."List:Cmd:Group:New"..msg.chat_id_)
end
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حذف الاوامر المضافه في المجموعه", 1, 'html')
end
if text == "ترتيب الاوامر" and Constructor(msg) then
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevAli:set(BRAND.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevAli:sadd(BRAND.."List:Cmd:Group:New"..msg.chat_id_,"رس")
...
DevAli:set(BRAND.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙ارسل الامر القديم", 1, 'html')
return false
end
if text == "حذف امر" or text == "مسح امر" and ChCheck(msg) then 
DevAli:set(BRAND.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevAli:smembers(BRAND.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevAli:get(BRAND.."Comd:New:rt:Ali:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevAli:smembers(BRAND.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevAli:del(BRAND.."Comd:New:rt:Ali:"..v..msg.chat_id_)
DevAli:del(BRAND.."Coomds"..msg.chat_id_)
end
...
DevAli:set(BRAND.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevAli:sadd(BRAND.."Coomds"..msg.chat_id_,ComdNew)  
DevAli:setex(BRAND.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n♪︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevAli:del(BRAND.."Comd:New:rt:Ali:"..ComdNew..msg.chat_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حذف الصلاحيه", 1, 'html')
end
if DevAli:get(BRAND.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء الامر", 1, 'html')
DevAli:del(BRAND.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevAli:get(BRAND.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevAli:set(BRAND.."Comd:New:rt:Ali:"..textn..msg.chat_id_,text)
...
if DevAli:sismember(BRAND.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrali = DevAli:get(BRAND.."Comd:New:rt:Ali:"..DEV_ABBAS..msg.chat_id_)
...
DevAli:set(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
DevAli:sadd(BRAND..'Ali:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrali == "ادمن" and Admin(msg) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'..' ❩\n♪︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAli:set(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)
DevAli:sadd(BRAND..'Ali:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrali == "مدير" and Manager(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'..' ❩\n♪︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAli:set(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)  
DevAli:sadd(BRAND..'Ali:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevAli:srem(BRAND..'Ali:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAli:del(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrali == "ادمن" and Admin(msg) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'..' ❩\n♪︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAli:srem(BRAND..'Ali:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAli:del(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrali == "مدير" and Manager(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'..' ❩\n♪︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevAli:srem(BRAND..'Ali:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAli:del(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrali == "عضو" then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'iinzzz')..')'..' ❩\n♪︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
end
...
if DevAli:sismember(BRAND.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrali = DevAli:get(BRAND.."Comd:New:rt:Ali:"..text1[2]..msg.chat_id_)
if mrali == "مميز" and VipMem(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:sadd(BRAND..'Ali:VipMem:'..msg.chat_id_, result.id_)
DevAli:set(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrali == "ادمن" and Admin(msg) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:sadd(BRAND..'Ali:Admins:'..msg.chat_id_, result.id_)
DevAli:set(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrali == "مدير" and Manager(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:sadd(BRAND..'Ali:Managers:'..msg.chat_id_, result.id_)
DevAli:set(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrali == "عضو" then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAli:srem(BRAND..'Ali:VipMem:'..msg.chat_id_, result.id_)
DevAli:del(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrali == "ادمن" and Admin(msg) then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:srem(BRAND..'Ali:Admins:'..msg.chat_id_, result.id_)
DevAli:del(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrali == "مدير" and Manager(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevAli:srem(BRAND..'Ali:Managers:'..msg.chat_id_, result.id_)
DevAli:del(BRAND.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrali == "عضو" then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'iinzzz')..')'..' ❩\n♪︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevAli:incr(BRAND..'Ali:UsersMsgs'..BRAND..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:incr(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:incr(BRAND..'Ali:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevAli:sismember(BRAND.."Ali:Users",msg.chat_id_) then
DevAli:sadd(BRAND.."Ali:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevAli:get(BRAND..'Ali:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
local inline = {{{text="♪ المطور .",url="t.me/"..(dp.username_ or "iinzzz")}}}
local start = DevAli:get(BRAND.."Ali:Start:Bot")
if start then 
Start_Source = start
else
...
DevAli:setex(BRAND..'Ali:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source BRAND     --
if not SecondSudo(msg) and not DevAli:sismember(BRAND..'Ali:Ban:Pv',msg.sender_user_id_) and not DevAli:get(BRAND..'Ali:Texting:Pv') then
...
DevAli:sadd(BRAND..'Ali:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '♪︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n♪︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevAli:srem(BRAND..'Ali:Ban:Pv',data.id_)  
return false  
end 
...
--     Source BRAND     --
if text and DevAli:get(BRAND..'Ali:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevAli:del(BRAND..'Ali:Start:Bots'..msg.sender_user_id_) 
return false
end
DevAli:set(BRAND.."Ali:Start:Bot",text)  
...
DevAli:set(BRAND..'Ali:Start:Bots'..msg.sender_user_id_,true) 
...
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل التواصل بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Texting:Pv') 
end
if text == 'تعطيل التواصل' or text == '↫ تعطيل التواصل ♪' then  
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل التواصل بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Texting:Pv',true) 
end
end
--     Source BRAND     --
if text == "الالعاب الترفيهيه" or text == "الالعاب الاحترافيه" or text == "الالعاب المتطوره" then
if not DevAli:get(BRAND..'Ali:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '♪ BRAND Team .', url="t.me/zvzzzz"}},
}
...
DevAli:incr(BRAND..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:set(BRAND.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevAli:get(BRAND.."Ali:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevAli:sadd(BRAND..'Ali:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevAli:srem(BRAND.."Ali:Groups", msg.chat_id_) 
...
if DevAli:get(BRAND..'Ali:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevAli:incr(BRAND..'Ali:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevAli:incr(BRAND..'Ali:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source BRAND     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevAli:get(BRAND..'Ali:Lock:FreeBot'..BRAND) then
if ChatType == 'pv' then
...
DevAli:sadd(BRAND..'Ali:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAli:srem(BRAND..'Ali:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevAli:sadd(BRAND..'Ali:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevAli:sadd(BRAND.."Ali:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAli:sadd(BRAND.."Ali:AliConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevAli:srem(BRAND.."Ali:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevAli:srem(BRAND.."Ali:AliConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevAli:sismember(BRAND..'Ali:Groups',msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevAli:get(BRAND..'Ali:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙عدد اعضاء المجموعه اقل من ↫ *'..(DevAli:get(BRAND..'Ali:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","♪︙تم تفعيل المجموعه "..dp.title_)  
DevAli:sadd(BRAND.."Ali:Groups",msg.chat_id_)
DevAli:sadd(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevAli:set(BRAND.."Ali:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevAli:set(BRAND..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source BRAND     --
local ReFalse = tostring(msg.chat_id_)
if not DevAli:sismember(BRAND.."Ali:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevAli:get(BRAND..'Ali:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevAli:sadd(BRAND..'Ali:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevAli:get(BRAND.."Ali:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = DevAli:smembers(BRAND.."Ali:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = DevAli:smembers(BRAND.."Ali:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = DevAli:smembers(BRAND.."Ali:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
if DevAli:get(BRAND..'Ali:Lock:NightClub'..msg.chat_id_) and msg.reply_to_message_id_ == 0 then
...
HttpsMsg = https.request('https://apiali.ml/nightclub.php?Get=BRAND&TokenBot='..TokenBot..'&Url='..UrlId)
...
local DelGpRedRedods = DevAli:get(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevAli:get(BRAND..'Ali:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevAli:del(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAli:srem(BRAND..'Ali:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevAli:get(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAli:del(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevAli:srem(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevAli:get(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAli:del(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevAli:srem(BRAND..'Ali:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevAli:get(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevAli:del(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_)
DevAli:del(BRAND.."Ali:Gif:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Voice:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Audio:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Photo:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Stecker:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Video:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:File:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Text:AllRed"..msg.content_.text_)
DevAli:del(BRAND.."Ali:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source BRAND     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevAli:get(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevAli:get(BRAND..'Ali:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevAli:smembers(BRAND..'Ali:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙♪︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevAli:del(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevAli:del(BRAND..'Ali:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevAli:srem(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevAli:sadd(BRAND..'Ali:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevAli:get(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevAli:sismember(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_,text) then
local BRANDTEAM =  DevAli:smembers(BRAND..'Ali:Text:GpTexts'..text..msg.chat_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '['..BRANDTEAM[math.random(#BRANDTEAM)]..']' , 1, 'md')  
end
end
--     Source BRAND     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevAli:get(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevAli:get(BRAND..'DelManagerRep'..msg.chat_id_)
DevAli:srem(BRAND..'Ali:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ الرد', 1, 'md')
DevAli:del(BRAND..'Ali:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevAli:del(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevAli:del(BRAND..'DelManagerRep'..msg.chat_id_)
return false
end
DevAli:del(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevAli:get(BRAND..'Ali:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevAli:set(BRAND..'Ali:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevAli:set(BRAND..'Ali:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevAli:set(BRAND..'Ali:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevAli:set(BRAND..'Ali:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevAli:set(BRAND..'Ali:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevAli:set(BRAND..'Ali:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevAli:set(BRAND..'Ali:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevAli:set(BRAND..'Ali:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevAli:get(BRAND..'Ali:Lock:GpRed'..msg.chat_id_) then 
if DevAli:get(BRAND..'Ali:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(BRAND..'Ali:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAli:get(BRAND..'Ali:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(BRAND..'Ali:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAli:get(BRAND..'Ali:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND..'Ali:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAli:get(BRAND..'Ali:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND..'Ali:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAli:get(BRAND..'Ali:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND..'Ali:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevAli:get(BRAND..'Ali:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND..'Ali:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevAli:get(BRAND..'Ali:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(BRAND..'Ali:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevAli:get(BRAND..'Ali:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function BRANDTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAli:get(BRAND..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAli:get(BRAND..'Ali:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevAli:get(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevAli:get(BRAND..'DelSudoRep')
DevAli:del(BRAND.."Ali:Sudo:AllRed",DelSudoRep)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ الرد', 1, 'md')
DevAli:del(BRAND.."Ali:Add:AllText"..msg.sender_user_id_)
DevAli:del(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_)
DevAli:del(BRAND.."DelSudoRep")
return false
end
DevAli:del(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevAli:get(BRAND.."Ali:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevAli:set(BRAND.."Ali:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevAli:set(BRAND.."Ali:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevAli:set(BRAND.."Ali:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevAli:set(BRAND.."Ali:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevAli:set(BRAND.."Ali:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevAli:set(BRAND.."Ali:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevAli:set(BRAND.."Ali:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevAli:set(BRAND.."Ali:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ الرد الجديد', 1, 'md') 
DevAli:del(BRAND.."Ali:Add:AllText"..msg.sender_user_id_)
DevAli:del(BRAND..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevAli:get(BRAND..'Ali:Lock:AllRed'..msg.chat_id_) then
if DevAli:get(BRAND.."Ali:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(BRAND.."Ali:Video:AllRed"..msg.content_.text_))
end
if DevAli:get(BRAND.."Ali:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(BRAND.."Ali:File:AllRed"..msg.content_.text_))
end
if DevAli:get(BRAND.."Ali:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND.."Ali:Voice:AllRed"..msg.content_.text_))
end
if DevAli:get(BRAND.."Ali:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND.."Ali:Audio:AllRed"..msg.content_.text_))
end
if DevAli:get(BRAND.."Ali:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND.."Ali:Photo:AllRed"..msg.content_.text_))
end
if  DevAli:get(BRAND.."Ali:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevAli:get(BRAND.."Ali:Gif:AllRed"..msg.content_.text_))
end
if DevAli:get(BRAND.."Ali:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevAli:get(BRAND.."Ali:Stecker:AllRed"..msg.content_.text_))
end
if DevAli:get(BRAND.."Ali:Text:AllRed"..msg.content_.text_) then
function BRANDTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevAli:get(BRAND..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevAli:get(BRAND.."Ali:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevAli:sismember(BRAND..'Ali:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevAli:sadd(BRAND..'Ali:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source BRAND     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= BRAND then
floods = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevAli:get(BRAND.."Ali:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevAli:setex(BRAND.."Ali:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source BRAND     --
...
DevAli:set(BRAND..'Ali:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevAli:get(BRAND..'Ali:PinnedMsg'..msg.chat_id_)
if pin_id and DevAli:get(BRAND..'Ali:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevAli:get(BRAND..'Ali:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevAli:del(BRAND..'Ali:viewget'..msg.sender_user_id_)
else
...
if DevAli:get(BRAND..'Ali:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevAli:get(BRAND..'Ali:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevAli:get(BRAND..'Ali:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevAli:get(BRAND..'Ali:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevAli:get(BRAND..'Ali:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevAli:get(BRAND..'Ali:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevAli:get(BRAND..'Ali:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevAli:get(BRAND..'Ali:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevAli:get(BRAND..'Ali:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAli:get(BRAND..'Ali:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevAli:get(BRAND..'Ali:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source BRAND     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevAli:get(BRAND..'Ali:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevAli:get(BRAND..'Ali:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevAli:get(BRAND..'Ali:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• @username'
end
...
if DevAli:get(BRAND.."Ali:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source BRAND     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevAli:get(BRAND..'Ali:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = BRAND,offset_ = 0,limit_ = 1},function(extra,alii,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(BRAND) then 
if DevAli:sismember(BRAND..'Ali:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n♪︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n♪︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n♪︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevAli:get(BRAND.."Ali:Text:BotWelcome") then AliText = DevAli:get(BRAND.."Ali:Text:BotWelcome") else AliText = "♪︙مرحبا انا بوت اسمي "..NameBot.."\n♪︙حالة المجموعه ↫ "..BotText.."\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉" end 
if DevAli:get(BRAND.."Ali:Photo:BotWelcome") then AliPhoto = DevAli:get(BRAND.."Ali:Photo:BotWelcome") elseif alii.photos_[0] then AliPhoto = alii.photos_[0].sizes_[1].photo_.persistent_id_ else AliPhoto = nil end 
...
if DevAli:get(BRAND..'Ali:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source BRAND     --
...
if DevAli:get(BRAND..'Ali:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(BRAND..'Ali:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(BRAND..'Ali:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevAli:get(BRAND..'Ali:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(BRAND..'Ali:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevAli:get(BRAND..'Ali:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevAli:get(BRAND..'Ali:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevAli:get(BRAND..'Ali:Spam:Text'..msg.chat_id_))
end
if DevAli:get(BRAND..'Ali:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source BRAND     --
if DevAli:get(BRAND.."Ali:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"♪︙تم الغاء حفظ الرابط")       
DevAli:del(BRAND.."Ali:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevAli:set(BRAND.."Ali:Groups:Links"..msg.chat_id_,Link)
...
if DevAli:get('BRANDTEAM:'..BRAND.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAli:del('BRANDTEAM:'..BRAND..'id:user'..msg.chat_id_)  
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء الامر', 1, 'md')
DevAli:del('BRANDTEAM:'..BRAND.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAli:del('BRANDTEAM:'..BRAND.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAli:get('BRANDTEAM:'..BRAND..'id:user'..msg.chat_id_)  
DevAli:incrby(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Ali(msg.chat_id_, msg.id_,  1, "♪︙تم اضافة "..numadded..' رساله', 1, 'md')
DevAli:del('BRANDTEAM:'..BRAND..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevAli:get('BRANDTEAM:'..BRAND.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAli:del('BRANDTEAM:'..BRAND..'ids:user'..msg.chat_id_)  
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء الامر', 1, 'md')
DevAli:del('BRANDTEAM:'..BRAND.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAli:del('BRANDTEAM:'..BRAND.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAli:get('BRANDTEAM:'..BRAND..'ids:user'..msg.chat_id_)  
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevAli:get(BRAND.."Ali:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevAli:get(BRAND.."Ali:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","♪︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevAli:get(BRAND.."Ali:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevAli:get(BRAND.."Ali:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevAli:get(BRAND.."Ali:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevAli:smembers(BRAND..'Ali:Groups') 
local BotName = (DevAli:get(BRAND.."Ali:NameBot") or 'لورين')
local GetJson = '{"BotId": '..BRAND..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevAli:get(BRAND.."Ali:Groups:Links"..v)
Welcomes = DevAli:get(BRAND..'Ali:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
AliConstructors = DevAli:smembers(BRAND..'Ali:AliConstructor:'..v)
Constructors = DevAli:smembers(BRAND..'Ali:BasicConstructor:'..v)
BasicConstructors = DevAli:smembers(BRAND..'Ali:Constructor:'..v)
Managers = DevAli:smembers(BRAND..'Ali:Managers:'..v)
Admis = DevAli:smembers(BRAND..'Ali:Admins:'..v)
Vips = DevAli:smembers(BRAND..'Ali:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
--     Source BRAND     --
if DevAli:get(BRAND.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Ali( msg.chat_id_, msg.id_, 1,"♪︙يوجد فقط ( 6 ) اختيارات\n♪︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevAli:get(BRAND.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAli:del(BRAND.."SET:GAME"..msg.chat_id_)   
Dev_Ali( msg.chat_id_, msg.id_, 1,'♪︙*المحيبس باليد رقم* ↫ '..NUM..'\n♪︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevAli:get(BRAND..'DevAli4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "♪︙تم الغاء الامر")
DevAli:del(BRAND..'DevAli4'..msg.sender_user_id_)
return false  end 
DevAli:del(BRAND..'DevAli4'..msg.sender_user_id_)
...
DevAli:set(BRAND..'Ali:ChId',data.id_)
else
...
--     Source BRAND     --
if DevAli:get(BRAND.."Ali:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevAli:del(BRAND.."Ali:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء الامر', 1, 'md')
return false 
end 
DevAli:del(BRAND.."Ali:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevAli:set(BRAND.."DevText", DevText)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ كليشة المطور", 1, "md")
end
if DevAli:get(BRAND..'Ali:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevAli:del(BRAND..'Ali:NameBot'..msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ اسم البوت ', 1, 'html')
DevAli:del(BRAND..'Ali:NameBot'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:NameBot', text)
return false 
end
--     Source BRAND     --
if text == "الرابط" then
if not DevAli:get(BRAND.."Ali:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevAli:get(BRAND.."Private:Group:Link"..msg.chat_id_) 
...
Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM[math.random(#BRANDTEAM)] , 1, 'html') 
return false
end
...
if text and text == (DevAli:get(BRAND..'Ali:NameBot') or 'لورين') then 
NameBot = (DevAli:get(BRAND..'Ali:NameBot') or 'لورين')
local BRANDTEAM = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM[math.random(#BRANDTEAM)] , 1, 'html') 
return false 
end
if text =='نقاطي' and ChCheck(msg) then 
if tonumber((DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙لم تربح اي نقطه\n♪︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙عدد النقاط التي ربحتها ↫ '..(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAli:del(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAli:del(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع نقاطك', 1, 'md') end
--     Source BRAND     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) then
if not DevAli:get(BRAND..'Ali:Lock:Games'..msg.chat_id_) then
DevAli2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
Dev_Ali(msg.chat_id_, msg.id_, 1,BRANDTEAM, 1, 'md')
return false
end end
if text == DevAli:get(BRAND..'Ali:GameNum'..msg.chat_id_) and not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
BRANDTEAM = '♪︙مبروك لقد ربحت في اللعبه \n♪︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Ali(msg.chat_id_, msg.id_, 1,BRANDTEAM, 1, 'md')
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevAli:set(BRAND..'Ali:Games:Ids'..msg.chat_id_,true)
end
...
if not DevAli:get(BRAND..'Ali:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevAli:set(BRAND.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevAli:setex(BRAND.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum2'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(BRAND..'Ali:GameNum2'..msg.chat_id_) and not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum3'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(BRAND..'Ali:GameNum3'..msg.chat_id_) and not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
...
DevAli2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum4'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == DevAli:get(BRAND..'Ali:GameNum4'..msg.chat_id_) and not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum5'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(BRAND..'Ali:GameNum5'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(BRAND..'Ali:GameNum5'..msg.chat_id_)
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum6'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(BRAND..'Ali:GameNum6'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(BRAND..'Ali:GameNum6'..msg.chat_id_)
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum7'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(BRAND..'Ali:GameNum7'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(BRAND..'Ali:GameNum7'..msg.chat_id_)
...
name = DevAli2[math.random(#DevAli2)]
DevAli:set(BRAND..'Ali:GameNum8'..msg.chat_id_,name)
DevAli:del(BRAND..'Ali:Games:Ids'..msg.chat_id_)
...
if text == DevAli:get(BRAND..'Ali:GameNum8'..msg.chat_id_) then
if not DevAli:get(BRAND..'Ali:Games:Ids'..msg.chat_id_) then 
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevAli:del(BRAND..'Ali:GameNum8'..msg.chat_id_)
...
--     Source BRAND     --
if DevAli:get(BRAND.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Ali(msg.chat_id_, msg.id_, 1,"♪︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevAli:get(BRAND.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevAli:del(BRAND..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAli:del(BRAND.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙*التخمين الصحيح هو* ↫ '..NUM..'\n♪︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevAli:incrby(BRAND..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevAli:get(BRAND..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevAli:del(BRAND..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAli:del(BRAND.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n♪︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevAli:get(BRAND..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevAli:get(BRAND..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevAli:set(BRAND.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n♪︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevAli:setex(BRAND.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source BRAND     --
if text == 'روليت' then
if not DevAli:get(BRAND..'Ali:Lock:Games'..msg.chat_id_) then
DevAli:del(BRAND.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAli:del(BRAND..'Ali:ListRolet'..msg.chat_id_)  
DevAli:setex(BRAND.."Ali:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevAli:get(BRAND.."Ali:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "♪︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevAli:set(BRAND.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '♪︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n♪︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevAli:del(BRAND.."Ali:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevAli:get(BRAND.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevAli:sismember(BRAND..'Ali:ListRolet'..msg.chat_id_,text) then
...
DevAli:sadd(BRAND..'Ali:ListRolet'..msg.chat_id_,text)
local CountAdd = DevAli:get(BRAND.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevAli:scard(BRAND..'Ali:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevAli:del(BRAND.."Ali:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevAli:setex(BRAND.."Ali:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevAli0 = (DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevAli:incrby(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevAli0)
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙تم بيع '..(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n♪︙كل نقطه تساوي 50 رساله', 'md')
DevAli:del(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source BRAND     --
...
DevAli:sadd(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevAli:sadd(BRAND..'Ali:AliConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevAli:get(BRAND.."Ali:Left:Bot"..BRAND) and not SecondSudo(msg) then
...
local msguser = tonumber(DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevAli:get(BRAND..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevAli:setex(BRAND..'DevAli4'..msg.sender_user_id_,360,true)
...
function BRANDTEAM(extra,result,success)
if DevAli:get(BRAND.."Ali:Send:Bot"..BRAND) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"♪︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevAli:smembers(BRAND.."Ali:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevAli:smembers(BRAND.."Ali:Users")
...
DevAli:set(BRAND..'Ali:viewget'..msg.sender_user_id_,true)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˛ ˛BRAND tِٰaِmٌٓe 🦇.',url="https://t.me/iinzzz"}},
...
if DevAli:get(BRAND.."Ali:Kick:Me"..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevAli:set(BRAND..'yes'..msg.sender_user_id_, 'delyes')
DevAli:set(BRAND..'no'..msg.sender_user_id_, 'delno')
...
DevAli:set(BRAND.."Ali:Kick:Me"..msg.chat_id_, true)
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل امر اطردني'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevAli:del(BRAND.."Ali:Kick:Me"..msg.chat_id_)
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل امر اطردني'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source BRAND     --
if text == "نزلني" and ChCheck(msg) then
if DevAli:get(BRAND.."Ali:Del:Me"..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevAli:set(BRAND..'yesdel'..msg.sender_user_id_, 'delyes')
DevAli:set(BRAND..'nodel'..msg.sender_user_id_, 'delno')
...
DevAli:set(BRAND.."Ali:Del:Me"..msg.chat_id_, true)
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل امر نزلني'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevAli:del(BRAND.."Ali:Del:Me"..msg.chat_id_)
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل امر نزلني'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source BRAND     --
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:TagAll'..msg.chat_id_)
end
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevAli:get(BRAND..'Ali:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "♪︙وينكم يالربع \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevAli:get(BRAND..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevAli:get(BRAND..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevAli:get(BRAND..'Ali:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevAli:get(BRAND..'Ali:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevAli:get(BRAND..'Ali:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAli:get(BRAND..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAli:get(BRAND..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAli:del(BRAND..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAli:del(BRAND..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source BRAND     --
if text and (text == 'المطور' or text == 'مطور' or text == '↫  المطور ♪') and not DevAli:get(BRAND..'Ali:Devinline:Pv'..msg.chat_id_) then
...
if not DevAli:get(BRAND..'Ali:Lock:Stupid'..msg.chat_id_) then
...
if DevAli:sismember(BRAND.."Ali:AliConstructor:"..msg.chat_id_,result.id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
Dev_Ali(msg.chat_id_, result.id_, 1,''..BRANDTEAM[math.random(#BRANDTEAM)], 1, 'html') 
else  
...
if DevAli:sismember(BRAND.."Ali:AliConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local BRANDTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
Dev_Ali(msg.chat_id_, result.id_, 1,''..BRANDTEAM[math.random(#BRANDTEAM)], 1, 'md') 
end 
...
if DevAli:sismember(BRAND..'Ali:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAli:sismember(BRAND..'Ali:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAli:sismember(BRAND..'Ali:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAli:sismember(BRAND..'Ali:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAli:sismember(BRAND..'Ali:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevAli:sismember(BRAND..'Ali:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAli:sismember(BRAND..'Ali:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAli:sismember(BRAND..'Ali:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevAli:sismember(BRAND..'Ali:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAli:sismember(BRAND..'Ali:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAli:sismember(BRAND..'Ali:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevAli:srem(BRAND..'Ali:SecondSudo:', result.sender_user_id_)
DevAli:srem(BRAND..'Ali:SudoBot:', result.sender_user_id_)
DevAli:srem(BRAND..'Ali:ManagerAll:', result.sender_user_id_)
DevAli:srem(BRAND..'Ali:AdminAll:', result.sender_user_id_)
DevAli:srem(BRAND..'Ali:VipAll:', result.sender_user_id_)
DevAli:srem(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevAli:srem(BRAND..'Ali:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevAli:srem(BRAND..'Ali:Managers:'..msg.chat_id_, result.sender_user_id_)
DevAli:srem(BRAND..'Ali:Admins:'..msg.chat_id_, result.sender_user_id_)
DevAli:srem(BRAND..'Ali:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevAli:srem(BRAND..'Ali:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevAli:sismember(BRAND..'Ali:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevAli:sismember(BRAND..'Ali:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevAli:sismember(BRAND..'Ali:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAli:sismember(BRAND..'Ali:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAli:sismember(BRAND..'Ali:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevAli:sismember(BRAND..'Ali:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevAli:sismember(BRAND..'Ali:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevAli:sismember(BRAND..'Ali:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevAli:sismember(BRAND..'Ali:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevAli:sismember(BRAND..'Ali:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevAli:sismember(BRAND..'Ali:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if AliDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevAli:srem(BRAND..'Ali:SecondSudo:', result.id_)
DevAli:srem(BRAND..'Ali:SudoBot:', result.id_)
DevAli:srem(BRAND..'Ali:ManagerAll:', result.id_)
DevAli:srem(BRAND..'Ali:AdminAll:', result.id_)
DevAli:srem(BRAND..'Ali:VipAll:', result.id_)
DevAli:srem(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,result.id_)
DevAli:srem(BRAND..'Ali:Constructor:'..msg.chat_id_,result.id_)
DevAli:srem(BRAND..'Ali:Managers:'..msg.chat_id_, result.id_)
DevAli:srem(BRAND..'Ali:Admins:'..msg.chat_id_, result.id_)
DevAli:srem(BRAND..'Ali:VipMem:'..msg.chat_id_, result.id_)
DevAli:srem(BRAND..'Ali:Cleaner:'..msg.chat_id_, result.id_)
elseif AliDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
DevAli:srem(BRAND..'Ali:SudoBot:', result.id_)
DevAli:srem(BRAND..'Ali:ManagerAll:', result.id_)
DevAli:srem(BRAND..'Ali:AdminAll:', result.id_)
...
DevAli:sadd(BRAND..'Ali:SecondSudo:',result.sender_user_id_)
...
if result.id_ then
DevAli:sadd(BRAND..'Ali:SecondSudo:',result.id_)
...
DevAli:sadd(BRAND..'Ali:SecondSudo:',user)
...
DevAli:srem(BRAND..'Ali:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:SudoBot:',result.id_)
...
DevAli:sadd(BRAND..'Ali:SudoBot:',user)
...
DevAli:srem(BRAND..'Ali:SudoBot:',user)
...
DevAli:sadd(BRAND..'Ali:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:ManagerAll:',result.id_)
...
DevAli:sadd(BRAND..'Ali:ManagerAll:',user)
...
DevAli:srem(BRAND..'Ali:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:AdminAll:',result.id_)
...
DevAli:sadd(BRAND..'Ali:AdminAll:',user)
...
DevAli:srem(BRAND..'Ali:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:VipAll:',result.id_)
...
DevAli:sadd(BRAND..'Ali:VipAll:',user)
...
DevAli:srem(BRAND..'Ali:VipAll:',user)
...
function raf_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:AliConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:AliConstructor:'..msg.chat_id_,result.id_)
...
DevAli:sadd(BRAND..'Ali:AliConstructor:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:AliConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevAli:srem(BRAND..'Ali:AliConstructor:'..msg.chat_id_,result.id_)
...
DevAli:srem(BRAND..'Ali:AliConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevAli:sadd(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:BasicConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:Constructor:'..msg.chat_id_,result.id_)
...
DevAli:sadd(BRAND..'Ali:Constructor:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:Constructor:'..msg.chat_id_,user)
...
DevAli:sadd(BRAND..'Ali:Managers:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:Managers:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
DevAli:sadd(BRAND..'Ali:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAli:sadd(BRAND..'Ali:Cleaner:'..msg.chat_id_,result.id_)
...
DevAli:sadd(BRAND..'Ali:Cleaner:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevAli:get(BRAND.."Ali:Lock:ProSet"..msg.chat_id_) then 
...
DevAli:sadd(BRAND..'Ali:Admins:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:Admins:'..msg.chat_id_,user)
...
DevAli:sadd(BRAND..'Ali:VipMem:'..msg.chat_id_,user)
...
DevAli:srem(BRAND..'Ali:VipMem:'..msg.chat_id_,user)
...
if text == "راسلني" then
BRANDTEAM = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,BRANDTEAM[math.random(#BRANDTEAM)])
end
--     Source BRAND     --
...
DevAli:del(BRAND.."Ali:Lock:ProSet"..msg.chat_id_)
...
DevAli:set(BRAND.."Ali:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and DevAli:get(BRAND.."Ali:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevAli:sadd(BRAND..'Ali:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
DevAli:sadd(BRAND..'Ali:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevAli:sadd(BRAND..'Ali:Ban:'..msg.chat_id_, user)
...
DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_, result.id_)
...
DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and DevAli:get(BRAND.."Ali:Lock:MuteTked"..msg.chat_id_) then 
...
if DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","♪︙هو بالفعل مكتوم من المجموعه")  
else
DevAli:sadd(BRAND..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","♪︙هو بالفعل مكتوم من المجموعه")  
else
DevAli:sadd(BRAND..'Ali:Muted:'..msg.chat_id_, result.id_)
...
if DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","♪︙هو بالفعل مكتوم من المجموعه")  
else
DevAli:sadd(BRAND..'Ali:Muted:'..msg.chat_id_, user)
...
if not DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","♪︙هو ليس مكتوم لالغاء كتمه")  
else
DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","♪︙هو ليس مكتوم لالغاء كتمه")  
else
DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_, result.id_)
...
if not DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","♪︙هو ليس مكتوم لالغاء كتمه")  
else
DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_, user)
...
DevAli:sadd(BRAND..'Ali:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAli:sadd(BRAND..'Ali:Tkeed:'..msg.chat_id_, result.id_)
...
DevAli:sadd(BRAND..'Ali:Tkeed:'..msg.chat_id_, user)
...
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_, result.id_)
...
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_, user)
...
if DevAli:sismember(BRAND..'Ali:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevAli:sadd(BRAND..'Ali:BanAll:', result.sender_user_id_)
...
if DevAli:sismember(BRAND..'Ali:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevAli:sadd(BRAND..'Ali:BanAll:', result.id_)
...
if DevAli:sismember(BRAND..'Ali:SecondSudo:',user) and not Sudo(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevAli:sadd(BRAND..'Ali:BanAll:', user)
...
DevAli:sadd(BRAND..'Ali:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevAli:sadd(BRAND..'Ali:MuteAll:', result.id_)
...
DevAli:sadd(BRAND..'Ali:MuteAll:', user)
...
DevAli:srem(BRAND..'Ali:BanAll:', result.sender_user_id_)
DevAli:srem(BRAND..'Ali:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevAli:srem(BRAND..'Ali:BanAll:', result.id_)
DevAli:srem(BRAND..'Ali:MuteAll:', result.id_)
...
DevAli:srem(BRAND..'Ali:BanAll:', user)
DevAli:srem(BRAND..'Ali:MuteAll:', user)
...
DevAli:setex(BRAND.."Ali:EditDev"..msg.sender_user_id_,300,true)
end
if DevAli:get(BRAND.."Ali:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'♪︙تم الغاء امر تغير المطور الاساسي')
DevAli:del(BRAND.."Ali:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevAli:del(BRAND.."Ali:EditDev"..msg.sender_user_id_)
DevAli:set(BRAND.."Ali:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source BRAND     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevAli:get(BRAND..'Ali:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevAli:sismember(BRAND..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","♪︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","♪︙تم رفعه في قائمة المطايه") 
DevAli:sadd(BRAND..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source BRAND     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevAli:get(BRAND..'Ali:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevAli:sismember(BRAND..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","♪︙هو ليس مطي ليتم تنزيله") 
else
DevAli:srem(BRAND..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevAli:set('BRANDTEAM:'..BRAND..'id:user'..msg.chat_id_,TXT)  
DevAli:setex('BRANDTEAM:'..BRAND.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAli:del(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevAli:incrby(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevAli:set('BRANDTEAM:'..BRAND..'ids:user'..msg.chat_id_,TXT)  
DevAli:setex('BRANDTEAM:'..BRAND.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevAli:incrby(BRAND..'Ali:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevAli:get(BRAND..'Ali:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevAli:sadd(BRAND.."Ali:cleaner"..msg.chat_id_, msg.id_) else DevAli:sadd(BRAND.."Ali:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevAli:sismember(BRAND.."Ali:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevAli:set(BRAND..'Ali:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevAli:smembers(BRAND..'Ali:VipMem:'..msg.chat_id_)
text = "♪︙قائمة المميزين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..ali)
text = "♪︙قائمة الادمنيه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:Managers:'..msg.chat_id_)
text = "♪︙قائمة المدراء ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:Cleaner:'..msg.chat_id_)
text = "♪︙قائمة المنظفين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:Constructor:'..msg.chat_id_)
text = "♪︙قائمة المنشئين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:AliConstructor:'..msg.chat_id_)
text = "♪︙قائمة المالكين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:BasicConstructor:'..msg.chat_id_)
...
local List = DevAli:smembers(BRAND..'Ali:Muted:'..msg.chat_id_)
...
local List = DevAli:smembers(BRAND..'Ali:Tkeed:'..msg.chat_id_)
text = "♪︙قائمة المقيدين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:Ban:'..msg.chat_id_)
...
local List = DevAli:hkeys(BRAND..'Ali:Filters:'..msg.chat_id_)
text = "♪︙قائمة المنع ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevAli:smembers(BRAND..'User:Donky:'..msg.chat_id_)
...
local List = DevAli:smembers(BRAND..'Ali:SecondSudo:')
...
local BanAll = DevAli:smembers(BRAND..'Ali:BanAll:')
local MuteAll = DevAli:smembers(BRAND..'Ali:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevAli:smembers(BRAND..'Ali:SudoBot:')
text = "♪︙قائمة المطورين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local sudouser = DevAli:get(BRAND..'Ali:Sudos'..v) 
local username = DevAli:get(BRAND..'Save:UserName'..v)
if username then
...
local List = DevAli:smembers(BRAND..'Ali:ManagerAll:')
...
local List = DevAli:smembers(BRAND..'Ali:VipAll:')
...
DevAli:sadd(BRAND.."Ali:AliConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevAli:srem(BRAND.."Ali:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAli:srem(BRAND.."Ali:FilterPhoto"..msg.chat_id_,photo)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAli:srem(BRAND.."Ali:FilterAnimation"..msg.chat_id_,idanimation)
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Thwel:Ali'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل تحويل الصيغ'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Thwel:Ali'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevAli:get(BRAND..'Ali:Thwel:Ali'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevAli:sismember(BRAND..'Ali:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevAli:sismember(BRAND..'Ali:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevAli:sismember(BRAND..'Ali:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevAli:sismember(BRAND..'Ali:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAli:sismember(BRAND..'Ali:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n♪︙عدد الكروبات ↫ '..(DevAli:get(BRAND..'Ali:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevAli:sismember(BRAND..'Ali:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevAli:sismember(BRAND..'Ali:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevAli:sismember(BRAND..'Ali:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevAli:sismember(BRAND..'Ali:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAli:sismember(BRAND..'Ali:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n♪︙عدد الكروبات ↫ '..(DevAli:get(BRAND..'Ali:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevAli:sismember(BRAND..'Ali:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevAli:sismember(BRAND..'Ali:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevAli:sismember(BRAND..'Ali:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevAli:sismember(BRAND..'Ali:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevAli:sismember(BRAND..'Ali:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n♪︙عدد الكروبات ↫ '..(DevAli:get(BRAND..'Ali:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAli:sismember(BRAND..'Ali:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAli:sismember(BRAND..'Ali:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAli:sismember(BRAND..'Ali:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAli:sismember(BRAND..'Ali:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevAli:sismember(BRAND..'Ali:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevAli:sismember(BRAND..'Ali:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevAli:sismember(BRAND..'Ali:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevAli:sismember(BRAND..'Ali:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevAli:sismember(BRAND..'Ali:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙الحظر العام ↫ '..banall..'\n♪︙الكتم العام ↫ '..muteall..'\n♪︙الحظر ↫ '..banned..'\n♪︙الكتم ↫ '..muted..'\n♪︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_,result.sender_user_id_) DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_,result.sender_user_id_) DevAli:srem(BRAND..'Ali:BanAll:',result.sender_user_id_) DevAli:srem(BRAND..'Ali:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_,result.sender_user_id_) DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_,user) DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_,user) DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_,user) DevAli:srem(BRAND..'Ali:BanAll:',user) DevAli:srem(BRAND..'Ali:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_,user) DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_,user) DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_,result.id_) DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_,result.id_) DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_,result.id_) DevAli:srem(BRAND..'Ali:BanAll:',result.id_) DevAli:srem(BRAND..'Ali:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_,result.id_) DevAli:srem(BRAND..'Ali:Ban:'..msg.chat_id_,result.id_) DevAli:srem(BRAND..'Ali:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevAli:set(BRAND.."Ali:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevAli:set("BRAND:New:id:"..BRAND..msg.sender_user_id_,'BRANDTEAM')
return "BRANDTEAM"
end
if text and DevAli:get("BRAND:New:id:"..BRAND..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAli:del("BRAND:New:id:"..BRAND..msg.sender_user_id_)
return false
end
DevAli:del("BRAND:New:id:"..BRAND..msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevAli:set(BRAND.."Ali:AllIds:Text",text)
return false
end
...
DevAli:del(BRAND.."Ali:AllIds:Text")
end
end
--     Source BRAND     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙رجائا اتبع التعليمات للتعيين \n♪︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAli:set("BRAND:New:id:"..BRAND..msg.chat_id_..msg.sender_user_id_,'BRANDTEAM')
return "BRANDTEAM"
end
if text and Manager(msg) and DevAli:get("BRAND:New:id:"..BRAND..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAli:del("BRAND:New:id:"..BRAND..msg.chat_id_..msg.sender_user_id_)
return false
end
DevAli:del("BRAND:New:id:"..BRAND..msg.chat_id_..msg.sender_user_id_)
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم حفظ الكليشه الجديده', 1, 'md')
DevAli:set(BRAND.."Ali:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم حذف كليشة الايدي")  
DevAli:del(BRAND.."Ali:GpIds:Text"..msg.chat_id_)
end
end
--     Source BRAND     --
if msg.reply_to_message_id_ ~= 0 then
...
function BRANDTEAM(extra,alii,success)
...
local msgsday = DevAli:get(BRAND..'Ali:UsersMsgs'..BRAND..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevAli:get(BRAND..'Ali:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevAli:get(BRAND..'Ali:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevAli:get(BRAND..'Ali:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevAli:get(BRAND..'Ali:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevAli:get(BRAND..'Ali:Lock:Id'..msg.chat_id_) then 
if not DevAli:get(BRAND..'Ali:Lock:Id:Photo'..msg.chat_id_) then 
if DevAli:get(BRAND.."Ali:AllIds:Text") then
newpicid = DevAli:get(BRAND.."Ali:AllIds:Text")
...
if not DevAli:get(BRAND.."Ali:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, alii.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevAli:get(BRAND.."Ali:GpIds:Text"..msg.chat_id_)
...
if DevAli:get(BRAND.."Ali:AllIds:Text") then
newallid = DevAli:get(BRAND.."Ali:AllIds:Text")
...
if DevAli:get(BRAND.."Ali:AllIds:Text") then
notpicid = DevAli:get(BRAND.."Ali:AllIds:Text")
...
if not DevAli:get(BRAND..'Ali:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم قفل الاباحي")  
DevAli:set(BRAND..'Ali:Lock:NightClub'..msg.chat_id_,true)
else
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙الاباحي بالفعل مقفل في المجموعه', 1, 'md')
end
end
if LockText[2] == "التعديل" then
if not DevAli:get(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم قفل التعديل")  
DevAli:set(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevAli:set(BRAND.."Ali:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevAli:get(BRAND..'Ali:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevAli:set(BRAND.."Ali:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم قفل التثبيت")  
DevAli:set(BRAND..'Ali:Lock:Pin'..msg.chat_id_,true)
DevAli:sadd(BRAND.."Ali:Lock:Pinpin",msg.chat_id_) 
else
...
DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevAli:get(BRAND..'Ali:Lock:Id:Photo'..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الايدي بالصوره'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevAli:get(BRAND..'Ali:Lock:Id'..msg.chat_id_) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙الايدي بالتاكيد معطل ', 1, 'md')
else
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الايدي بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source BRAND     --
...
DevAli:setex(BRAND.."Ali:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' or text == 'انشاء الرابط' then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevAli:get(BRAND.."Ali:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevAli:set(BRAND.."Ali:Groups:Links"..msg.chat_id_,LinkGroup) 
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND.."Ali:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الترحيب بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND.."Ali:Lock:Welcome"..msg.chat_id_)
end
if DevAli:get(BRAND..'Ali:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevAli:del(BRAND..'Ali:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAli:del(BRAND..'Ali:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevAli:set(BRAND..'Ali:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevAli:set(BRAND..'Ali:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم حذف الترحيب")  
DevAli:del(BRAND..'Ali:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevAli:get(BRAND..'Ali:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Ali(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source BRAND     --
if DevAli:get(BRAND..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء حفظ الوصف", 1, 'md')
DevAli:del(BRAND..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAli:del(BRAND..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAli:set(BRAND..'Ali:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevAli:set(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevAli:get(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر المنع', 1, 'md')
DevAli:del(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم منع الكلمه ↫ "..text, 1, 'html')
DevAli:del(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevAli:hset(BRAND..'Ali:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙ارسل لي الكلمه الان", 1, 'md') 
DevAli:set(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevAli:get(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر الغاء المنع', 1, 'md')
DevAli:del(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevAli:hget(BRAND..'Ali:Filters:'..msg.chat_id_, text) then  
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevAli:del(BRAND.."Ali:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevAli:hdel(BRAND..'Ali:Filters:'..msg.chat_id_, text)
...
local gps = DevAli:scard(BRAND.."Ali:Groups") local users = DevAli:scard(BRAND.."Ali:Users") 
...
local users = DevAli:scard(BRAND.."Ali:Users")
...
local gps = DevAli:scard(BRAND.."Ali:Groups")
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     Source BRAND     --
if text and text:match('^تنظيف (%d+)$') and ChCheck(msg) then  
if not DevAli:get(BRAND..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevAli:setex(BRAND..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
if text == "تنظيف المشتركين" and SecondSudo(msg) and ChCheck(msg) then 
local pv = DevAli:smembers(BRAND.."Ali:Users")
local sendok = 0
for i = 1, #pv do
...
DevAli:srem(BRAND.."Ali:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevAli:smembers(BRAND.."Ali:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevAli:srem(BRAND.."Ali:Groups",group[i]) 
...
Dev_Ali(msg.chat_id_, msg.id_, 1,'♪︙عدد الكروبات الان ↫ { '..#group..' }'..BRANDgp1..BRANDgp2..'\n♪︙العدد الحقيقي الان  ↫ ( '..BRANDgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:Clean'..msg.chat_id_,true)  
end
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:Clean'..msg.chat_id_) 
end
...
DevAli:set(BRAND..'Ali:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevAli:get(BRAND..'Ali:Lock:Clean'..msg.chat_id_) then
if DevAli:get(BRAND..'Ali:CleanNum'..msg.chat_id_) then CleanNum = DevAli:get(BRAND..'Ali:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevAli:scard(BRAND.."Ali:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevAli:smembers(BRAND.."Ali:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
DevAli:del(BRAND.."Ali:cleaner"..msg.chat_id_)
end 
end 
if Cleaner(msg) then
if DevAli:get(BRAND..'Ali:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevAli:scard(BRAND.."Ali:cleaner"..msg.chat_id_)
if M ~= 0 then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙عدد الميديا ↫ "..M.."\n♪︙الحذف التلقائي ↫ "..(DevAli:get(BRAND..'Ali:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
if DevAli:get(BRAND..'Ali:Lock:NightClub'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم فتح الاباحي")  
DevAli:del(BRAND..'Ali:Lock:NightClub'..msg.chat_id_)
else
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙الاباحي بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "التعديل" then
if DevAli:get(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم فتح التعديل")  
DevAli:del(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_)
else
...
DevAli:del(BRAND.."Ali:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
DevAli:hdel(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevAli:get(BRAND..'Ali:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم فتح التثبيت")  
DevAli:del(BRAND..'Ali:Lock:Pin'..msg.chat_id_)
DevAli:srem(BRAND.."Ali:Lock:Pinpin",msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Text'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Photo'..msg.chat_id_)
else
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevAli:get(BRAND..'Ali:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم فتح الكلايش")  
DevAli:del(BRAND..'Ali:Lock:Spam'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Join'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Videos'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Document'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Inline'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Markdown'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Gifs'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Music'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Voice'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Links'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Location'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Tags'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Hashtak'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Contact'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:WebLinks'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Arabic'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:English'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:TagServr'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Stickers'..msg.chat_id_)
else
...
DevAli:del(BRAND..'Ali:Lock:Forwards'..msg.chat_id_)
else
...
DevAli:set(BRAND.."Ali:Lock:Bots"..msg.chat_id_,"del") DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Ali:Lock:Links','Ali:Lock:Contact','Ali:Lock:Forwards','Ali:Lock:Videos','Ali:Lock:Gifs','Ali:Lock:EditMsgs','Ali:Lock:Stickers','Ali:Lock:Farsi','Ali:Lock:Spam','Ali:Lock:WebLinks','Ali:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevAli:set(BRAND..Lock..msg.chat_id_,true)
end
...
DevAli:del(BRAND..UnLock..msg.chat_id_)
end
...
DevAli:del(BRAND..'Ali:Lock:Fshar'..msg.chat_id_) DevAli:del(BRAND..'Ali:Lock:Taf'..msg.chat_id_) DevAli:del(BRAND..'Ali:Lock:Kfr'..msg.chat_id_) 
DevAli:set(BRAND.."Ali:Lock:Bots"..msg.chat_id_,"del") DevAli:hset(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevAli:set(BRAND..'Ali:Lock:Fshar'..msg.chat_id_,true) DevAli:set(BRAND..'Ali:Lock:Taf'..msg.chat_id_,true) DevAli:set(BRAND..'Ali:Lock:Kfr'..msg.chat_id_,true) DevAli:hdel(BRAND.."Ali:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevAli:set(BRAND..'Ali:Spam:Text'..msg.chat_id_,SetSpam)
...
DevAli:del(BRAND.."Ali:mem:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:Cleaner:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:VipMem:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:Admins:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:Managers:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:Constructor:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:BasicConstructor:Rd"..msg.chat_id_)
DevAli:del(BRAND.."Ali:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source BRAND     --
...
DevAli:del(BRAND..'Ali:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
DevAli:del(BRAND..'Ali:AliConstructor:'..msg.chat_id_)
...
DevAli:del(BRAND..'Ali:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم حذف المنشئين")  
DevAli:del(BRAND..'Ali:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم حذف المدراء")  
DevAli:del(BRAND..'Ali:Managers:'..msg.chat_id_)
end 
...
DevAli:srem(BRAND..'Ali:Tkeed:'..msg.chat_id_, v)
end 
...
DevAli:del(BRAND..'Ali:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","♪︙تم حذف قوائم المنع")  
DevAli:del(BRAND..'Ali:Filters:'..msg.chat_id_)
DevAli:del(BRAND.."Ali:FilterAnimation"..msg.chat_id_)
DevAli:del(BRAND.."Ali:FilterPhoto"..msg.chat_id_)
DevAli:del(BRAND.."Ali:FilterSteckr"..msg.chat_id_)
end
...
DevAli:del(BRAND..'Ali:Ban:'..msg.chat_id_) DevAli:del(BRAND..'Ali:Admins:'..msg.chat_id_) DevAli:del(BRAND..'User:Donky:'..msg.chat_id_) DevAli:del(BRAND..'Ali:VipMem:'..msg.chat_id_) DevAli:del(BRAND..'Ali:Filters:'..msg.chat_id_) DevAli:del(BRAND..'Ali:Muted:'..msg.chat_id_)
...
local basicconstructor = DevAli:smembers(BRAND..'Ali:BasicConstructor:'..msg.chat_id_)
local constructor = DevAli:smembers(BRAND..'Ali:Constructor:'..msg.chat_id_)
local Managers = DevAli:smembers(BRAND..'Ali:Managers:'..msg.chat_id_)
local admins = DevAli:smembers(BRAND..'Ali:Admins:'..msg.chat_id_)
local vipmem = DevAli:smembers(BRAND..'Ali:VipMem:'..msg.chat_id_)
local donky = DevAli:smembers(BRAND..'User:Donky:'..msg.chat_id_)
...
spam_c = DevAli:get(BRAND..'Ali:Spam:Text'..msg.chat_id_)
end
--     Source BRAND     --
if DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source BRAND     --
if DevAli:get(BRAND.."Ali:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevAli:get(BRAND.."Ali:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevAli:get(BRAND.."Ali:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source BRAND     --
if DevAli:get(BRAND..'Ali:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevAli:get(BRAND..'Ali:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:NightClub'..msg.chat_id_) then mute_nightclub = 'مقفل' else mute_nightclub = 'مفتوح' end
if DevAli:get(BRAND..'Ali:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevAli:get(BRAND.."Ali:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevAli:get(BRAND..'Ali:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevAli:get(BRAND..'Ali:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevAli:get(BRAND..'Ali:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevAli:get(BRAND..'Ali:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevAli:hget(BRAND.."Ali:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source BRAND     --
...
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل ميزة انطق'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Antk:Ali'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل ميزة انطق'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Antk:Ali'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevAli:get(BRAND..'Ali:Antk:Ali'..msg.chat_id_) then
...
--     Source BRAND     --
if DevAli:get(BRAND..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevAli:del(BRAND..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAli:del(BRAND..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:rules'..msg.chat_id_,text)
...
DevAli:set(BRAND..'Ali:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = DevAli:get(BRAND..'Ali:rules'..msg.chat_id_)
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Zrf:Ali'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الزخرفه بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Zrf:Ali'..msg.chat_id_,true)  
end
if DevAli:get(BRAND..'Zrf:Ali'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر الزخرفه', 1, 'md')
DevAli:del(BRAND..'Zrf:Ali'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevAli:get(BRAND..'Ali:Zrf:Ali'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevAli:setex(BRAND.."Zrf:Ali"..msg.chat_id_..msg.sender_user_id_,300,true)
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Brg:Ali'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الابراج بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Brg:Ali'..msg.chat_id_,true)  
end
if not DevAli:get(BRAND..'Ali:Brg:Ali'..msg.chat_id_) then
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Nsba:Ali'..msg.chat_id_) 
end
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Nsba:Ali'..msg.chat_id_,true)  
end
if not DevAli:get(BRAND..'Ali:Nsba:Ali'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevAli:set(BRAND..'LoveNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevAli:get(BRAND..'LoveNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الحب ', 1, 'md')
DevAli:del(BRAND..'LoveNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevAli:set(BRAND..'HataNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevAli:get(BRAND..'HataNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الكره ', 1, 'md')
DevAli:del(BRAND..'HataNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
DevAli:set(BRAND..'RjolaNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevAli:get(BRAND..'RjolaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevAli:del(BRAND..'RjolaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
DevAli:set(BRAND..'AnothaNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevAli:get(BRAND..'AnothaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevAli:del(BRAND..'AnothaNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
DevAli:set(BRAND..'StupidNsba:Ali'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevAli:get(BRAND..'StupidNsba:Ali'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevAli:del(BRAND..'StupidNsba:Ali'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Ali = math.random(0,100);
...
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل حساب العمر'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Age:Ali'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل حساب العمر'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Age:Ali'..msg.chat_id_,true)  
end
if not DevAli:get(BRAND..'Ali:Age:Ali'..msg.chat_id_) then
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Mean:Ali'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل معاني الاسماء'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Mean:Ali'..msg.chat_id_,true)  
end
if not DevAli:get(BRAND..'Ali:Mean:Ali'..msg.chat_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♪ BRAND TeAM .',url="t.me/iinzzz"}},
}
local msg_id = msg.id_/2097152/0.5
...
--     Source BRAND     --
if Admin(msg) then
if DevAli:get(BRAND..'Ali:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevAli:get(BRAND..'Ali:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الروابط ↫ "..mute_links.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAli:get(BRAND..'Ali:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙المعرف ↫ "..lock_tag.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAli:get(BRAND..'Ali:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙المتحركه ↫ "..mute_gifs.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الملصقات" then if DevAli:get(BRAND..'Ali:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الملصقات ↫ "..lock_sticker.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الصور" then if DevAli:get(BRAND..'Ali:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الصور ↫ "..mute_photo.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAli:get(BRAND..'Ali:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الفيديو ↫ "..mute_video.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الاونلاين" then if DevAli:get(BRAND..'Ali:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙الاونلاين ↫ "..mute_in.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الدردشه" then if DevAli:get(BRAND..'Ali:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الدردشه ↫ "..mute_text.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAli:get(BRAND..'Ali:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙التوجيه ↫ "..lock_forward.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الاغاني" then if DevAli:get(BRAND..'Ali:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الاغاني ↫ "..mute_music.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAli:get(BRAND..'Ali:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙الصوت ↫ "..mute_voice.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAli:get(BRAND..'Ali:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الجهات ↫ "..lock_contact.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الماركداون" then if DevAli:get(BRAND..'Ali:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙الماركداون ↫ "..markdown.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الهاشتاك" then if DevAli:get(BRAND..'Ali:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "التعديل" then if DevAli:get(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙التعديل ↫ "..mute_edit.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "التثبيت" then if DevAli:get(BRAND..'Ali:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙التثبيت ↫ "..lock_pin.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الاشعارات" then if DevAli:get(BRAND..'Ali:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الكلايش" then if DevAli:get(BRAND..'Ali:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الكلايش ↫ "..lock_spam.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الدخول" then if DevAli:get(BRAND..'Ali:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local BRANDTEAM = "\n" .."♪︙الدخول ↫ "..lock_Join.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الشبكات" then if DevAli:get(BRAND..'Ali:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الشبكات ↫ "..lock_wp.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "المواقع" then if DevAli:get(BRAND..'Ali:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙المواقع ↫ "..lock_location.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "العربيه" then if DevAli:get(BRAND..'Ali:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙العربيه ↫ "..lock_arabic.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الانكليزيه" then if DevAli:get(BRAND..'Ali:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local BRANDTEAM = "\n" .."♪︙الانكليزيه ↫ "..lock_english.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الكفر" then if DevAli:get(BRAND..'Ali:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local BRANDTEAM = "\n" .."♪︙الكفر ↫ "..lock_kaf.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الفشار" then if DevAli:get(BRAND..'Ali:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local BRANDTEAM = "\n" .."♪︙الفشار ↫ "..lock_fshar.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
if text == "الطائفيه" then if DevAli:get(BRAND..'Ali:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local BRANDTEAM = "\n" .."♪︙الطائفيه ↫ "..lock_taf.."\n" Dev_Ali(msg.chat_id_, msg.id_, 1, BRANDTEAM, 1, 'md') end
end
--     Source BRAND     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل كشف الاعدادات'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل كشف الاعدادات'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:LockSettings'..msg.chat_id_) 
end
--     Source BRAND     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل اوامر التحشيش'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل اوامر التحشيش'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:Stupid'..msg.chat_id_,true)
end
--     Source BRAND     --
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:Robot'..msg.chat_id_)
end
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:Robot'..msg.chat_id_,true)
end
--     Source BRAND     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل ردود المدير'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل ردود المدير'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:GpRed'..msg.chat_id_,true)
end
--     Source BRAND     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل ردود المطور'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل ردود المطور'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:AllRed'..msg.chat_id_,true)
end
--     Source BRAND     --
if SecondSudo(msg) then
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND.."Ali:Left:Bot"..BRAND)
end
if text == 'تعطيل المغادره' or text == '↫ تعطيل المغادره ♪' then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل المغادره بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND.."Ali:Left:Bot"..BRAND,true) 
end 
if text == 'تفعيل الاذاعه' or text == '↫ تفعيل الاذاعه ♪' then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل الاذاعه بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND.."Ali:Send:Bot"..BRAND)
end
if text == 'تعطيل الاذاعه' or text == '↫ تعطيل الاذاعه ♪' then 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الاذاعه بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND.."Ali:Send:Bot"..BRAND,true) 
end
end
--     Source BRAND     --
...
--     Source BRAND     --
if msg.content_.photo_ then
if DevAli:get(BRAND..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevAli:del(BRAND..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"♪︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevAli:del(BRAND..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevAli:set(BRAND..'Ali:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source BRAND     --
...
if data.ID == "Ok" then
DevAli:del(BRAND..'Ali:PinnedMsg'..msg.chat_id_)
...
local PinId = DevAli:get(BRAND..'Ali:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevAli:del(BRAND..'Ali:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevAli:scard(BRAND.."Ali:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevAli:scard(BRAND.."Ali:Constructor:"..ChatId) or 0
local BanedList = DevAli:scard(BRAND.."Ali:Ban:"..ChatId) or 0
local ManagerList = DevAli:scard(BRAND.."Ali:Managers:"..ChatId) or 0
local MutedList = DevAli:scard(BRAND.."Ali:Muted:"..ChatId) or 0
local TkeedList = DevAli:scard(BRAND.."Ali:Ali:Tkeed:"..ChatId) or 0
local AdminsList = DevAli:scard(BRAND.."Ali:Admins:"..ChatId) or 0
local VipList = DevAli:scard(BRAND.."Ali:VipMem:"..ChatId) or 0
...
DevAli:srem(BRAND.."Ali:Groups", dp.id_)
else
...
DevAli:set(BRAND..'Ali:Num:Add:Bot',Num) 
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:FreeBot'..BRAND) 
end 
end
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:FreeBot'..BRAND,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND..'Ali:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تعطيل الالعاب بنجاح'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND..'Ali:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙تم تفعيل جلب رابط المجموعه'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:del(BRAND.."Ali:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
DevAli:set(BRAND.."Ali:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
--     Source BRAND     --
...
ReplyStatus(msg,result.id_,"ReplyBy","♪︙تم تفعيل المجموعه "..dp.title_)  
DevAli:sadd(BRAND.."Ali:Groups",msg.chat_id_)
if not DevAli:get(BRAND..'Ali:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevAli:incrby(BRAND..'Ali:Sudos'..msg.sender_user_id_,1)
DevAli:set(BRAND..'Ali:SudosGp'..msg.sender_user_id_..msg.chat_id_,"ali")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevAli:sismember(BRAND..'Ali:Groups',msg.chat_id_) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './BRAND.lua', '♪︙نسخة ملف سورس لورين',dl_cb, nil)
end end
--     Source BRAND     --
...
for k,v in pairs(List) do
local GroupsManagers = DevAli:scard(BRAND.."Ali:Managers:"..v) or 0
local GroupsAdmins = DevAli:scard(BRAND.."Ali:Admins:"..v) or 0
local Groupslink = DevAli:get(BRAND.."Ali:Groups:Links" ..v)
...
DevAli:setex(BRAND.."Ali:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n♪︙للخروج ارسل ↫ ( الغاء ) \n ✓'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAli:get(BRAND.."Ali:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAli:del(BRAND.."Ali:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevAli:smembers(BRAND..'Ali:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
AliText = "الرساله"
...
DevAli:setex(BRAND.."Ali:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n♪︙للخروج ارسل ↫ ( الغاء ) \n ✓'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAli:get(BRAND.."Ali:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAli:del(BRAND.."Ali:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevAli:smembers(BRAND..'Ali:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
AliText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevAli:setex(BRAND.."Ali:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙ارسل الرساله الان لتوجيها \n♪︙للخروج ارسل ↫ ( الغاء ) \n ✓'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAli:get(BRAND.."Ali:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAli:del(BRAND.."Ali:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevAli:smembers(BRAND..'Ali:Groups')   
for k,v in pairs(List) do  
...
DevAli:setex(BRAND.."Ali:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙ارسل الرساله الان لتوجيها \n♪︙للخروج ارسل ↫ ( الغاء ) \n ✓'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAli:get(BRAND.."Ali:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAli:del(BRAND.."Ali:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevAli:smembers(BRAND..'Ali:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم اذاعة رسالتك بالتوجيه \n♪︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevAli:setex(BRAND.."Ali:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local BRANDTEAM = '♪︙اهلا عزيزي ↫ '..AliRank(msg)..' \n♪︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n♪︙للخروج ارسل ↫ ( الغاء ) \n ✓'
alimoned(msg.chat_id_, msg.sender_user_id_, msg.id_, BRANDTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevAli:get(BRAND.."Ali:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevAli:del(BRAND.."Ali:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevAli:smembers(BRAND.."Ali:Groups") 
if msg.content_.text_ then
...
AliText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
AliText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
AliText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
AliText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
AliText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
AliText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
AliText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
AliText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevAli:set(BRAND..'Ali:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local List = DevAli:smembers(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
DevAli:set(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevAli:get(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevAli:sismember(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_,text) then
...
DevAli:set(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevAli:set(BRAND..'Ali:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevAli:set(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
DevAli:set(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = DevAli:get(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevAli:set(BRAND..'Ali:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevAli:set(BRAND..'Ali:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevAli:sadd(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source BRAND     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = DevAli:smembers(BRAND..'Ali:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevAli:set(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and Manager(msg) and ChCheck(msg) then
DevAli:set(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevAli:get(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevAli:set(BRAND..'Ali:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevAli:set(BRAND..'Ali:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevAli:sadd(BRAND..'Ali:Manager:GpRed'..msg.chat_id_,text)
DevAli:set(BRAND..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source BRAND     --
if text == 'حذف رد عام' and SecondSudo(msg) or text == '↫ حذف رد عام ♪' and SecondSudo(msg) or text == 'مسح رد عام' and SecondSudo(msg) then
local List = DevAli:smembers(BRAND.."Ali:Sudo:AllRed")
if #List == 0 then
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevAli:set(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد عام' and SecondSudo(msg) or text == '↫ اضف رد عام ♪' and SecondSudo(msg) then
DevAli:set(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = DevAli:get(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_)
...
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n♪︙يمكنك اضافة الى النص ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n♪︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevAli:set(BRAND.."Ali:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevAli:set(BRAND.."Ali:Add:AllText"..msg.sender_user_id_, text)
DevAli:sadd(BRAND.."Ali:Sudo:AllRed",text)
DevAli:set(BRAND.."DelSudoRep",text)
return false 
end end
--     Source BRAND     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = DevAli:smembers(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_)
MsgRep = '♪︙قائمة الردود المتعدده ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevAli:smembers(BRAND..'Ali:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
DevAli:del(BRAND..'Ali:Text:GpTexts'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevAli:smembers(BRAND..'Ali:Manager:GpRed'..msg.chat_id_)
MsgRep = '♪︙ردود المدير ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
if DevAli:get(BRAND.."Ali:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevAli:get(BRAND.."Ali:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevAli:get(BRAND.."Ali:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevAli:get(BRAND.."Ali:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevAli:get(BRAND.."Ali:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevAli:get(BRAND.."Ali:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevAli:get(BRAND.."Ali:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevAli:get(BRAND.."Ali:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevAli:del(BRAND..'Ali:Gif:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Voice:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Audio:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Photo:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Stecker:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Video:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:File:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Text:GpRed'..v..msg.chat_id_)
DevAli:del(BRAND..'Ali:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevAli:smembers(BRAND.."Ali:Sudo:AllRed")
MsgRep = '♪︙ردود المطور ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
if DevAli:get(BRAND.."Ali:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevAli:get(BRAND.."Ali:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevAli:get(BRAND.."Ali:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevAli:get(BRAND.."Ali:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevAli:get(BRAND.."Ali:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevAli:get(BRAND.."Ali:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevAli:get(BRAND.."Ali:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevAli:get(BRAND.."Ali:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevAli:del(BRAND.."Ali:Add:AllRed"..v)
DevAli:del(BRAND.."Ali:Gif:AllRed"..v)
DevAli:del(BRAND.."Ali:Voice:AllRed"..v)
DevAli:del(BRAND.."Ali:Audio:AllRed"..v)
DevAli:del(BRAND.."Ali:Photo:AllRed"..v)
DevAli:del(BRAND.."Ali:Stecker:AllRed"..v)
DevAli:del(BRAND.."Ali:Video:AllRed"..v)
DevAli:del(BRAND.."Ali:File:AllRed"..v)
DevAli:del(BRAND.."Ali:Text:AllRed"..v)
DevAli:del(BRAND.."Ali:Sudo:AllRed")
end
...
DevAli:set(BRAND..'Ali:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevAli:set(BRAND..'Ali:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help0'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help0'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAli:set(BRAND..'Ali:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help01'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then 
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help01'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help1', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAli:set(BRAND..'Ali:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help21'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help21'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help2', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAli:set(BRAND..'Ali:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help31'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help31'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help3', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAli:set(BRAND..'Ali:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help41'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help41'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help4', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevAli:set(BRAND..'Ali:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help51'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help51'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help5', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevAli:set(BRAND..'Ali:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local BRANDTEAM =  DevAli:get(BRAND..'Ali:Help61'..msg.sender_user_id_)
if BRANDTEAM == 'msg' then
Dev_Ali(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevAli:del(BRAND..'Ali:Help61'..msg.sender_user_id_)
DevAli:set(BRAND..'Ali:Help6', text)
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
os.execute('wget https://raw.githubusercontent.com/BRANDTEM/BRAND/master/BRAND.lua') 
dofile('BRAND.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/BRANDTEM/BRANDFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/BRANDTEM/BRANDFiles/master/BRANDFiles/"..FileName)
if Res == 200 then
...
DevAli:del(BRAND..'Ali:Text:BotWelcome')
DevAli:del(BRAND..'Ali:Photo:BotWelcome')
return false
end 
...
DevAli:del(BRAND..'Ali:Lock:BotWelcome')
return false
end 
...
DevAli:set(BRAND..'Ali:Lock:BotWelcome',true)
return false
end 
...
DevAli:del(BRAND..'Ali:Text:BotWelcome')
DevAli:del(BRAND..'Ali:Photo:BotWelcome')
DevAli:set(BRAND.."Ali:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevAli:get(BRAND.."Ali:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء الامر", 1, "md") 
DevAli:del(BRAND.."Ali:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم حفظ النص ارسل لي صورة الترحيب\n♪︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevAli:set(BRAND.."Ali:Text:BotWelcome",text) 
DevAli:set(BRAND.."Ali:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevAli:get(BRAND.."Ali:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevAli:set(BRAND.."Ali:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevAli:setex(BRAND.."Ali:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevAli:del(BRAND.."DevText")
end end
--     Source BRAND     --
if DevAli:get(BRAND.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "♪︙تم الغاء الامر", 1, "md") 
DevAli:del(BRAND.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAli:del(BRAND.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevAli:set(BRAND..'Ali:ChText',texxt)
...
DevAli:setex(BRAND.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAli:incr(BRAND..'Ali:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevAli:get(BRAND..'Ali:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
local GetMsgPin = DevAli:get(BRAND..'Ali:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevAli:del(BRAND..'Ali:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevAli:del(BRAND..'Ali:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevAli:srem(BRAND..'Ali:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevAli:srem(BRAND..'Ali:Groups',v)  
end
...
DevAli:sadd(BRAND..'Ali:Groups',v)  
end end,nil) end
end
--     Source BRAND     --
end 
